    ...
    <div className="relative pl-1 bg-gray-100 flex justify-center rounded-xl hover:scale-105 duration-500 transform transition cursor-pointer" onClick={()=> cardDetails(nft)}>
        ...
        <div className="w-52 pb-2 bg-white rounded-xl shadow-xl z-10">
            <div className="relative">
                ...
                <img src={nft.properties.image} className="max-h-60 object-cover rounded-t-xl" alt="" />
            ...
            <div className="px-2 py-1">
                ...
                <div className="text-sm md:text-base font-bold pr-2">{nft.properties.name}</div>
                    ...
                    <div className="flex justify-between item-center">
                            <div className="flex items-center">
                                ...
                                <p className="text-gray-600 font-bold text-xs md:text-sm ml-1">
                                    4.96
                                    <span className="text-gray-500 font-normal">(76 rewiews)</span>
                                </p>
                            </div>
                    </div>
                </div>
